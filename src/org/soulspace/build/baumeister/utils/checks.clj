...
(defn code-module? [] (contains? (param :code-module-types) (param :type)))
(defn web-module? [] (contains? (param :web-module-types) (param :type)))
(defn app-module? [] (contains? (param :app-module-types) (param :type)))
(defn console-module? [] (contains? (param :console-module-types) (param :type)))
(defn data-module? [] (contains? (param :data-module-types) (param :type)))
